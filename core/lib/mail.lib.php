...
function new_email($from_email, $from_name, $to = array(), $subject, $body, $alt_body, $cc = array(), $bcc = array(), $reply_to_email = "", $reply_to_name = "")
{
    ...
    require '../core/third_party/PHPMailer/src/Exception.php';
    require '../core/third_party/PHPMailer/src/PHPMailer.php';
    require '../core/third_party/PHPMailer/src/SMTP.php';
    require '../core/third_party/PHPMailer/src/OAuth.php';
    require '../core/third_party/PHPMailer/src/POP3.php';
